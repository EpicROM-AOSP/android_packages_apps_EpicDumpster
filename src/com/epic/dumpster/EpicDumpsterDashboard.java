...
public class EpicDumpsterDashboard extends SettingsPreferenceFragment implements View.OnClickListener {
	...
	public void onCreate(Bundle icicle) {
        ...
        addPreferencesFromResource(R.xml.dumpster_dashboard);
		
		mPreference = findPreference("epic_header");
		aboutCard = mPreference.findViewById(R.id.epic_about_card);
		quickSettingsCard = mPreference.findViewById(R.id.epic_qspanel_card);
		statusBarCard = mPreference.findViewById(R.id.epic_statusbar_card);
	...
	public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider() {
                ...
                public List<SearchIndexableResource> getXmlResourcesToIndex(
                    ...
                    sir.xmlResId = R.xml.dumpster_dashboard;
