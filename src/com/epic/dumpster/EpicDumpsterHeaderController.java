...
public class EpicDumpsterHeaderController extends BasePreferenceController implements View.OnClickListener {
	
	private LayoutPreference mPreference;
	private MaterialCardView aboutCard;
	private LinearLayout quickSettingsCard, statusBarCard;
	
	public EpicDumpsterHeaderController(Context context, String key) {
		super(context, key);
	}
	...
	public void displayPreference(PreferenceScreen screen) {
		...
		mPreference = screen.findPreference("epic_header");
